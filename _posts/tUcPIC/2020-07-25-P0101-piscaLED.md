...
### Diretivas de compilação (config.h)

Algumas diretivas de compilação como `#pragma config` possibilitam o acesso a registradores de alguns periféricos de forma exclusiva durante a gravação do código.
